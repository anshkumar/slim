...
def inception_v2_base(inputs,
  ...
  if use_masked_conv2d:
    conv2d = tf.contrib.model_pruning.masked_conv2d
  else:
    conv2d = slim.conv2d
  ...
  with tf.compat.v1.variable_scope(scope, 'InceptionV2', [inputs]):
    with slim.arg_scope(
        [conv2d, slim.max_pool2d, slim.avg_pool2d],
        stride=1,
        padding='SAME',
      ...
      with tf.compat.v1.variable_scope(end_point):
        ...
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              ...
              scope='Conv2d_0a_1x1')
          branch_1 = conv2d(branch_1, depth(64), [3, 3],
                                 scope='Conv2d_0b_3x3')
      ...
      with tf.compat.v1.variable_scope(end_point):
        with tf.compat.v1.variable_scope('Branch_0'):
          branch_0 = conv2d(
              ...
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_0 = conv2d(branch_0, depth(160), [3, 3], stride=2,
                                 scope='Conv2d_1a_3x3')
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              net, depth(64), [1, 1],
      ...
      with tf.compat.v1.variable_scope(end_point):
        with tf.compat.v1.variable_scope('Branch_0'):
          branch_0 = conv2d(net, depth(224), [1, 1], scope='Conv2d_0a_1x1')
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              net, depth(64), [1, 1],
              weights_initializer=trunc_normal(0.09),
        ...
        with tf.compat.v1.variable_scope('Branch_2'):
          branch_2 = conv2d(
              ...
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_2 = conv2d(branch_2, depth(128), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_2 = conv2d(branch_2, depth(128), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.compat.v1.variable_scope('Branch_3'):
      ...
      with tf.compat.v1.variable_scope(end_point):
        ...
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              ...
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1 = conv2d(branch_1, depth(128), [3, 3],
                                 scope='Conv2d_0b_3x3')
        with tf.compat.v1.variable_scope('Branch_2'):
          branch_2 = conv2d(
              net, depth(96), [1, 1],
      ...
      with tf.compat.v1.variable_scope(end_point):
        with tf.compat.v1.variable_scope('Branch_0'):
          branch_0 = conv2d(net, depth(160), [1, 1], scope='Conv2d_0a_1x1')
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1 = conv2d(branch_1, depth(160), [3, 3],
                                 scope='Conv2d_0b_3x3')
        with tf.compat.v1.variable_scope('Branch_2'):
          branch_2 = conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_2 = conv2d(branch_2, depth(160), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_2 = conv2d(branch_2, depth(160), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.compat.v1.variable_scope('Branch_3'):
      ...
      with tf.compat.v1.variable_scope(end_point):
        with tf.compat.v1.variable_scope('Branch_0'):
          branch_0 = conv2d(net, depth(96), [1, 1], scope='Conv2d_0a_1x1')
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1 = conv2d(branch_1, depth(192), [3, 3],
                                 scope='Conv2d_0b_3x3')
        with tf.compat.v1.variable_scope('Branch_2'):
          branch_2 = conv2d(
              net, depth(160), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_2 = conv2d(branch_2, depth(192), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_2 = conv2d(branch_2, depth(192), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.compat.v1.variable_scope('Branch_3'):
      ...
      with tf.compat.v1.variable_scope(end_point):
        with tf.compat.v1.variable_scope('Branch_0'):
          branch_0 = conv2d(
              ...
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_0 = conv2d(branch_0, depth(192), [3, 3], stride=2,
                                 scope='Conv2d_1a_3x3')
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              net, depth(192), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1 = conv2d(branch_1, depth(256), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_1 = conv2d(branch_1, depth(256), [3, 3], stride=2,
                                 scope='Conv2d_1a_3x3')
        with tf.compat.v1.variable_scope('Branch_2'):
      ...
      with tf.compat.v1.variable_scope(end_point):
        with tf.compat.v1.variable_scope('Branch_0'):
          branch_0 = conv2d(net, depth(352), [1, 1], scope='Conv2d_0a_1x1')
        with tf.compat.v1.variable_scope('Branch_1'):
          branch_1 = conv2d(
              net, depth(192), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1 = conv2d(branch_1, depth(320), [3, 3],
                                 scope='Conv2d_0b_3x3')
        with tf.compat.v1.variable_scope('Branch_2'):
          branch_2 = conv2d(
              net, depth(160), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_2 = conv2d(branch_2, depth(224), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_2 = conv2d(branch_2, depth(224), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.compat.v1.variable_scope('Branch_3'):
